...
function buildPrompt(reviews, placeName, totalCollected) {
...
function buildResult(parsed, placeName, avgRating, totalReviews) {
    return {
        placeName,
...
async function summarizeWithOllama(reviews, placeName, settings, googleRating, googleReviewCount) {
    ...
    return buildResult(parseAIResponse(data.response ?? ''), placeName, avgRating, googleReviewCount ?? reviews.length);
}
// ─── OpenAI ───────────────────────────────────────────────────────────────────
async function summarizeWithOpenAI(reviews, placeName, settings, googleRating, googleReviewCount) {
...
// ─── Anthropic Claude ─────────────────────────────────────────────────────────
async function summarizeWithAnthropic(reviews, placeName, settings, googleRating, googleReviewCount) {
...
// ─── Google Gemini ────────────────────────────────────────────────────────────
async function summarizeWithGemini(reviews, placeName, settings, googleRating, googleReviewCount) {
...
// ─── Groq ─────────────────────────────────────────────────────────────────────
async function summarizeWithGroq(reviews, placeName, settings, googleRating, googleReviewCount) {
